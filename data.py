...
class SQuAD():
    def __init__(self, args):
        path = '/content/drive/My Drive/Colab Notebooks/Quesandanswer/dataset'
        ...
        self.WORD.build_vocab(self.train, self.dev, vectors=GloVe(name='6B', dim=args.word_dim), vectors_cache ='/content/drive/My Drive/Colab Notebooks/Quesandanswer/vector_cache')
